...
feature_oi = "burst_duration_delta_ms"

df_fc = df_.query("feature_name == @feature_oi and loc == 'VCVS' and hemisphere == 'left'")
#z-score the correlation per patient 
df_fc["correlation_zc"] = df_fc.groupby("subject")["correlation"].transform(stats.zscore)
